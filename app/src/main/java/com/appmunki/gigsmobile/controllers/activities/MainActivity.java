...
import com.appmunki.gigsmobile.adapters.DrawerAdapter;
import com.appmunki.gigsmobile.controllers.fragments.GigDetailFragment;
import com.appmunki.gigsmobile.controllers.fragments.GigListFragment;
...
public class MainActivity extends Activity implements GigListFragment.OnGigListInteractionListener, FragmentManager.OnBackStackChangedListener, GigDetailFragment.OnGigDetailInteractionListener {
    ...
    private void showMyGigs() {
        ...
        UtilTempo.currentUser = mCurrentUser;
    ...
    private void showGigDetailFragmentA(Gig gig) {
    ...
    private void showGigPaymentFragment(Gig gig) {
