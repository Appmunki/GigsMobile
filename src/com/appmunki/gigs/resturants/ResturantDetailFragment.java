 ...
 * either contained in a {@link ResturantListActivity} in two-pane mode (on
 * tablets) or a {@link ResturantDetailActivity} on handsets.
 */
public class ResturantDetailFragment extends Fragment {
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container,
		...
		View rootView = inflater.inflate(R.layout.fragment_resturant_detail,
				container, false);
