 ...
 * {@link ResturantListActivity}.
 * <p>
 * This activity is mostly just a 'shell' activity containing nothing more than
 * a {@link ResturantDetailFragment}.
 */
public class ResturantDetailActivity extends FragmentActivity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		if (savedInstanceState == null) {
			...
			arguments.putString(
					ResturantDetailFragment.ARG_ITEM_ID,
					getIntent().getStringExtra(
							ResturantDetailFragment.ARG_ITEM_ID));
			ResturantDetailFragment fragment = new ResturantDetailFragment();
			fragment.setArguments(arguments);
			getSupportFragmentManager().beginTransaction()
					.add(R.id.resturant_detail_container, fragment).commit();
		}
	}
